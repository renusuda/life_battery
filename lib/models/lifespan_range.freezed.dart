...
extension LifespanRangePatterns on LifespanRange {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LifespanRange value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(DateTime birthDate, DateTime deathDate)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _LifespanRange() when $default != null:
        return $default(_that.birthDate, _that.deathDate);
      case _:
        return orElse();
    }
  }
